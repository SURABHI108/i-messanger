...
<body>
    <a href="http://localhost/project/room/group/show_grp_detail.php">Back</a>
    <table class="menu" align="center" cellspacing="20px" cellpadding="20px">
        <tr>
            <td>
                <a href="http://localhost/project/room/group/file_message.php">
                    <img src="http://localhost/Project/symbol/file_download.jpg" class="logo">
                    <div class="label">File download</div>
                </a>
            </td>
            <td>
                <a href="http://localhost/project/room/group/genratepdf.php">
